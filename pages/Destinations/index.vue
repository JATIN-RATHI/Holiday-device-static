        ...
        <div class="container">
            <div class="hero-special my-5 bg-light">
                <div class="speciality-blog p-3">
                    <h2> Tour Packages</h2>
                    <h5>Go beyond the usual, plan something special. Find your true reason and set on the trail of
                        unique
                        travel!</h5>
                    <p class="d-block">Holiday Device speciality tour packages let you create special moments as you
                        learn
                        to celebrate
                        life all over again with our travel mantra! We offer the most interesting domestic and
                        international tour packages for you. The handcrafted tours provide you non-stop fun and
                        entertainment along with ample time to unwind and <span id="dots">...</span><span id="more">soak
                            in
                            the beauty of the destinations that
                            you visit. Our speciality tour packages are relaxing and carefully planned itineraries. We
                            make
                            sure you have all the fun and entertainment and also get sufficient time to relax and soak
                            in
                            the surroundings. Come with us, create special moments and celebrate life all over again!
                            Escape
                            to stunning holiday destinations, where a perfect break awaits you! Find your special
                            reason,
                            set on to meet new people and trace out your new journeys of life. We make sure you have all
                            the
                            fun and entertainment and also get sufficient time to relax and soak in the surroundings.
                            Live
                            the special moments and celebrate life all over again because we thrive to empower you with
                            the
                            most fascinating memories and invite you to relish our legacy to travel, explore and
                            celebrate
                            life.</span></p>
                    <a @click="readMore()" id="moreBtn">Read more&nbsp;
                        <FontAwesomeIcon id="down" icon="fa-chevron-down" />
                    </a>
                    <a @click="readMore()" id="lessBtn">Read less&nbsp;
            ...
            <div>
                ...
                <div v-if="showModal" class="modal-vue">
                    ...
                    <div class="modal o-section container d-block justify-content-center align-items-center">
                        <a id="close" style="cursor:pointer;padding-left: 100%;" @click="hide()">
                        ...
                        <form>
                            ...
                            <textarea id="field" name="description" cols="30" rows="4"
                                placeholder="Describe your enquiry we'll get back to you asap!"></textarea>
                        </form>
...
@Component({
    ...
    async fetch() {
        const pageData = (await contentfulRequest.getHolidayDevicePageContent()) || {}
        this.$data.destinationData = pageData.pageContent
        const heroData = (await contentfulRequest.getHolidayDeviceHeroContent()) || {}
        let myData: any = []
